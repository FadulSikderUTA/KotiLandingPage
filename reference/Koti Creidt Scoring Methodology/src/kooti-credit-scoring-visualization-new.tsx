...
import { ChevronRight, AlertCircle, Users, Database, Brain, LineChart } from 'lucide-react';
...
import DataCollectionEcosystem from "./components/DataCollectionEcosystem";
...
const KootiCSMVisualization = () => {
  ...
  return (
    <div className="flex flex-col w-full h-full bg-background text-foreground font-sans rounded-lg shadow-lg overflow-hidden">
