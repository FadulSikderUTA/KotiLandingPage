...
export default function RiskIntelligenceCard({
  ...
  const RiskDashboardMockup = () => (
    ...
    >
      ...
      <div
        ...
        data-oid="j-m._jz"
      >
        <div className="flex items-center gap-3" data-oid="yu2ozap">
          <div
      ...
      >
        ...
        >
          ...
          <div className="text-xs text-blue-700 font-medium" data-oid="p1w5i6m">
        ...
        >
          ...
          <div className="text-xs text-red-700 font-medium" data-oid="4vj-bs1">
      ...
      <div className="space-y-4 mb-6" data-oid="g-d0t-6">
        <div className="flex items-center justify-between" data-oid="toyzxl5">
          <h4
            className="text-sm font-semibold text-gray-700"
            data-oid="83iqxat"
          >
          ...
          <span className="text-xs text-gray-500" data-oid=":uicq_u">
            {lang === "bn" ? "গত ৩০ দিন" : "Last 30 days"}
          </span>
        </div>

        {/* Enhanced Risk Bar */}
        <div className="relative" data-oid="9a:wxcw">
          <div
          ...
          <div
            ...
            data-oid="07vp6sr"
          >
            <div className="text-green-600 font-medium" data-oid="4v7896u">
              {lang === "bn" ? "নিম্ন (40%)" : "Low (40%)"}
            </div>
            <div className="text-yellow-600 font-medium" data-oid="r_vfilm">
              {lang === "bn" ? "মাঝারি (30%)" : "Medium (30%)"}
            </div>
            <div className="text-orange-600 font-medium" data-oid="m0b5z0w">
              {lang === "bn" ? "উচ্চ (20%)" : "High (20%)"}
            </div>
            <div className="text-red-600 font-medium" data-oid="ryk.zwj">
      ...
      >
        ...
        <div className="space-y-2" data-oid="fxcb3_a">
          {[
            {
              time: "2 min ago",
              action:
            ...
            <motion.div
              ...
              data-oid="05:gsq-"
            >
              <div className="flex items-center gap-3" data-oid="8_jn_f.">
                <div
                  ...
                  data-oid="laup3_7"
                ></div>
                <span className="text-xs text-gray-700" data-oid="277out0">
                  {item.action}
                </span>
              </div>
              <span className="text-xs text-gray-400" data-oid="-st4ox0">
                {item.time}
              </span>
            </motion.div>
          ))}
  ...
  return (
    <BusinessSolutionCard
      icon={<Shield size={32} color="white" data-oid="35y25mp" />}
      category={data.category}
      title={data.title}
      description={data.description}
      features={data.features}
      mockup={<RiskDashboardMockup data-oid="l._e9f." />}
      cta={data.cta}
      lang={lang}
      data-oid="aeovvpq"
    />
