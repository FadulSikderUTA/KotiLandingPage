...
export default function MoneyManagementCard({
  ...
  return (
    <div className="w-full h-full p-6 flex flex-col" data-oid=":ct4mdc">
      {/* Header */}
      <div className="flex justify-between items-start mb-4" data-oid="0my:m1i">
        <div data-oid="7qqpsfi">
          ...
          <p className="text-sm text-[#0d0d0d]/70 max-w-2xl" data-oid="klqfk6q">
            {t.description}
          </p>
        </div>
        <motion.a
            ...
            >
              ...
              {index === 3 && (
                ...
                >
                  ...
                  <line x1="12" y1="17" x2="12.01" y2="17" data-oid="pysyne8" />
                </svg>
              )}
            </motion.div>
            <p
